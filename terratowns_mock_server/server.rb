...
# we will mock having a state or database for our mock server for this development server
...
# This will representour Home resources as a ruby object. 
class Home
...
# We are extending a classs from Sinatra Base to
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # was there a user id in the body payload json?
    if params['user_uuid'].nil?
      error 401, "a1002 Failed to authenicate, bearer token invalid and/or teacherseat_user_uuid invalid"
    end

    # the code and the user_uuid should be mathcing for user
